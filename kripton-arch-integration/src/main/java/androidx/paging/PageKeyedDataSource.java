...
public abstract class PageKeyedDataSource<Key, Value> extends ContiguousDataSource<Key, Value> {
    ...
    public abstract static class LoadInitialCallback<Key, Value> {
         ...
         *                   {@code data}.
         */
        public abstract void onResult(@NonNull List<Value> data, int position, int totalCount, @Nullable Key previousPageKey, @Nullable Key nextPageKey);
         ...
         */
        public abstract void onResult(@NonNull List<Value> data, @Nullable Key previousPageKey, @Nullable Key nextPageKey);
    }
    ...
    static class LoadCallbackImpl<Key, Value> extends LoadCallback<Key, Value> {
        ...
        LoadCallbackImpl(@NonNull PageKeyedDataSource<Key, Value> dataSource, @PageResult.ResultType int type, @Nullable Executor mainThreadExecutor, @NonNull PageResult.Receiver<Value> receiver) {
     ...
     */
    public abstract void loadInitial(@NonNull LoadInitialParams<Key> params, @NonNull LoadInitialCallback<Key, Value> callback);
     ...
     */
    public abstract void loadBefore(@NonNull LoadParams<Key> params, @NonNull LoadCallback<Key, Value> callback);
     ...
     * @param callback Callback that receives loaded data.
     */
    public abstract void loadAfter(@NonNull LoadParams<Key> params, @NonNull LoadCallback<Key, Value> callback);
