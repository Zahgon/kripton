...
public abstract class BindTypeBuilder {
    ...
    public static void generateBinderInit(Builder classBuilder, MethodSpec.Builder methodBuilder, ModelClass<?> entity) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
    ...
    private static void generateParseOnXml(BindTypeContext context, BindEntity entity) {
        ...
        addParameter(typeName(XMLParser.class), "xmlParser").addParameter(EventType.class, "currentEventType").returns(typeName(entity.getElement())).addException(Exception.class);
        // @formatter:on
    ...
    private static void generateParseOnJackson(BindTypeContext context, BindEntity entity) {
        // @formatter:off
        MethodSpec.Builder methodBuilder = MethodSpec.methodBuilder("parseOnJackson").addJavadoc("parse with jackson\n").addAnnotation(Override.class).addModifiers(Modifier.PUBLIC).// .addParameter(typeName(AbstractJacksonContext.class),
        // "context")
        addParameter(typeName(JsonParser.class), "jacksonParser").returns(typeName(entity.getElement())).addException(Exception.class);
        // @formatter:on
        boolean mutableObject = entity.isMutablePojo();
        if (mutableObject) {
            methodBuilder.addStatement("$T instance = new $T()", entity.getElement(), entity.getElement());
    ...
    private static void generateSerializeOnJackson(BindTypeContext context, BindEntity entity) {
        // @formatter:off
        MethodSpec.Builder methodBuilder = MethodSpec.methodBuilder("serializeOnJackson").addAnnotation(Override.class).addModifiers(Modifier.PUBLIC).// .addParameter(typeName(AbstractJacksonContext.class),
        // "context")
        addParameter(typeName(entity.getElement()), "object").addParameter(typeName(JsonGenerator.class), "jacksonSerializer").returns(Integer.TYPE).addException(Exception.class);
        // @formatter:on
    ...
    private static void generateSerializeOnJacksonAsString(BindTypeContext context, BindEntity entity) {
        // @formatter:off
        MethodSpec.Builder methodBuilder = MethodSpec.methodBuilder("serializeOnJacksonAsString").addAnnotation(Override.class).addModifiers(Modifier.PUBLIC).// .addParameter(typeName(AbstractJacksonContext.class),
        // "context")
        addParameter(typeName(entity.getElement()), "object").addParameter(typeName(JsonGenerator.class), "jacksonSerializer").returns(Integer.TYPE).addException(Exception.class);
        // @formatter:on
        // methodBuilder.beginControlFlow("try");
    ...
    private static void generateSerializeOnXml(BindTypeContext context, BindEntity entity) {
        ...
        addParameter(typeName(entity.getElement()), "object").addParameter(typeName(XMLSerializer.class), "xmlSerializer").addParameter(typeName(EventType.class), "currentEventType").returns(Void.TYPE).addException(Exception.class);
        // @formatter:on
        methodBuilder.beginControlFlow("if (currentEventType == $T.$L)", EventType.class, EventType.START_DOCUMENT);
        ...
        for (Pair<String, String> namespace : entity.xmlInfo.namespaces) {
            if (StringUtils.hasText(namespace.value0)) {
                methodBuilder.addStatement("xmlSerializer.writeAttribute(\"\", $S, $S)", "xmlns:" + namespace.value0, namespace.value1);
            } else {
