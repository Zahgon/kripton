 ...
 * @author xcesco
 */
public class ByteSQLTransform extends WrappedSQLTransformation {

    public ByteSQLTransform() {
        this(true);
    }

    /**
     * Instantiates a new byte SQL transform.
     *
     * @param nullable the nullable
     */
    public ByteSQLTransform(boolean nullable) {
        super(nullable);
        defaultValue = "0";
        if (nullable) {
            defaultValue = "null";
